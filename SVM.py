...
hotelCancedData = pd.read_csv(
    "C:\\Users\\ADMIN\\OneDrive - student.ptithcm.edu.vn\\Desktop\\môn kì này\\TTNT\\triTueNhanTao\\Hotel-Reservations.csv")
...
X_train, X_test, Y_train, Y_test = train_test_split(X, Y, test_size=0.2)  # 20% dùng để kiểm tra, 80% dùng để huấn luyện
